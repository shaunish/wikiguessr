    ...
    return (
        <div>
          {this.state.introShow ? (
            <>
            <h1 className="Home_title__ANWNn">
             Welcome to Wikiguessr! 
            </h1>
            <div className="Home_container__5xSil">
            <button className="Home_card__ehRyT" onClick={this.beginGame}> BEGIN! </button>
              <Popup trigger={<button className="Home_card__ehRyT"> How To Play</button>}>
            ...
            <div>
              <h1 className="Home_quote__5Qh66">{this.state.questionState}</h1>
              <div>


                      <button  className="Home_card__ehRyT" onClick={() => this.handleButtonClick(this.state.answer0)} value={this.state.answer0}><h3>{this.state.answer0}</h3></button>

                        <button  className="Home_card__ehRyT" onClick={() => this.handleButtonClick(this.state.answer1)} value={this.state.answer1}><h3>{this.state.answer1}</h3></button>
              </div>
              <div>

                        <button  className="Home_card__ehRyT" onClick={() => this.handleButtonClick(this.state.answer2)} value={this.state.answer2}><h3>{this.state.answer2}</h3></button>

                        <button  className="Home_card__ehRyT" onClick={() => this.handleButtonClick(this.state.answer3)} value={this.state.answer3}><h3>{this.state.answer3}</h3></button>
              </div>
              ...
              {this.state.correctAnswerShow ? (
                this.state.correctAnswerClicked ? (
                  <div>
                    <h3>Correct!!! &#x1F525; &#x1F525; &#x1F525;</h3>
                    <button className="Home_card__ehRyT" onClick={this.handleNextButtonClick}>Next Question</button>
                  </div>
                ) : (
                  <div>
